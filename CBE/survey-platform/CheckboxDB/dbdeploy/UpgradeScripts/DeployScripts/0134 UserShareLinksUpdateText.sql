IF NOT EXISTS (SELECT TOP 1 * FROM ckbx_Text WHERE TextID = N'/pageText/forms/surveys/invitations/AddRecipients.aspx/userOnlyFilterTitle')
BEGIN
	INSERT [dbo].[ckbx_Text] ([TextID], [LanguageCode], [TextValue], [PageId]) VALUES (N'/pageText/forms/surveys/invitations/AddRecipients.aspx/userOnlyFilterTitle', N'en-US', N'Select users to receive links', NULL)
END

GO

IF NOT EXISTS (SELECT TOP 1 * FROM ckbx_Text WHERE TextID = N'/pageText/forms/surveys/invitations/AddRecipients.aspx/generateLinks')
BEGIN
	INSERT [dbo].[ckbx_Text] ([TextID], [LanguageCode], [TextValue], [PageId]) VALUES (N'/pageText/forms/surveys/invitations/AddRecipients.aspx/generateLinks', N'en-US', N'Generate Links', NULL)
END
