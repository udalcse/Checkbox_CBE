...
namespace Checkbox.Web.Page
{
    ...
    /// </summary>
    public abstract class ExportResultsPage : ResponseTemplatePage
    {
        /// <summary>
        ...
        /// 
        /// </summary>
        protected override string PageSpecificTitle { get { return WebTextManager.GetText("/pageText/reporting.aspx/exportResponses"); } }
        ...
        /// </summary>
        protected override string PageRequiredRolePermission { get { return "Analysis.Responses.Export"; } }
        ...
        protected override void OnPageInit()
        {
            ...
            if (Master is BaseMasterPage)
            {
                ((BaseMasterPage)Master).SetTitle(
                    WebTextManager.GetText("/pageText/forms/surveys/responses/export.aspx/title")
                    + " - " + Utilities.StripHtml(ResponseTemplate.Name.Replace("'", "&#39;"), 64));
            }
        ...
        {
            string fileName = FileUtilities.FixFileName(ResponseTemplate.Name, ".", string.Empty);

            //Get file name
			if ("XML".Equals(ExportOptions.ExportMode, StringComparison.InvariantCultureIgnoreCase))
			{
				fileName += "_xmlExport.xml";
			}
			else if("CSV".Equals(ExportOptions.ExportMode, StringComparison.InvariantCultureIgnoreCase))
            {
                fileName += "_csvExport.csv";
            }
            else if ("SPSS_CSV".Equals(ExportOptions.ExportMode, StringComparison.InvariantCultureIgnoreCase))
            {
                fileName += "_spssExport.csv";
            }
            else
            {
                fileName += "_spss.sav";
        ...
        protected void PrepareResponse()
        {
            ...
            Response.ContentEncoding = ExportOptions.OutputEncoding;
        }
