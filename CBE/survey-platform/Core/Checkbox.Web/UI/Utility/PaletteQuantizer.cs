...
namespace Checkbox.Web.UI.Utility
{
    /// <summary>
    ...
    {
        bool _backgroundBackColorSpecified;

        /// <summary>
        /// Construct the palette quantizer
        /// </summary>
        /// <param name="palette">The color palette to quantize to</param>
        /// <param name="backgroundBackColorSpecified"></param>
        /// <remarks>
        /// Palette quantization only requires a single quantization step
        /// </remarks>
        public PaletteQuantizer(ArrayList palette, bool backgroundBackColorSpecified)
            : base(true)
        {
            _colorMap = new Hashtable();

            _backgroundBackColorSpecified = backgroundBackColorSpecified;
        ...
        protected override ColorPalette GetPalette(ColorPalette palette)
        {
            ...
            // Added to make the first palette entry transparent IF the backgroundBackColor is not set...
            if (!_backgroundBackColorSpecified)
