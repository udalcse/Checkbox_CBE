...
namespace Prezza.Framework.Common
{
	...
	public sealed class ArgumentValidation
	{
		...
		public static void CheckForEmptyString(string variable, string variableName)
		{
			...
			{
				throw new ArgumentException("Argument " + variableName + " must not be empty.", variableName);
			}
		}
		...
		public static void CheckForInvalidNullNameReference(string name, string messageName)
		{
			...
			{
				throw new InvalidOperationException("Operation is invalid for the object's current state.");
			}
		}
		...
		public static void CheckForZeroBytes(byte[] bytes, string variableName)
		{
			...
			if (bytes.Length == 0)
			{
				throw new ArgumentException("Byte array value must be greater than zero bytes.", variableName);
			}
		}
		...
		public static void CheckExpectedType(object variable, Type type)
		{
			...
			{
				throw new ArgumentException("Argument was not the expected type: " + type.FullName);
			}
		}
		...
		public static void CheckEnumeration(Type enumType, object variable, string variableName)
		{
			...
			{
				throw new ArgumentException("Enumeration is not defined: " + enumType.FullName, variableName);
			}
		}
	}
}