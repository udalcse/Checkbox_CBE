...
namespace Checkbox.Common.Captcha.Image.TextGenerators
{
	...
	/// </summary>
	internal class ThickThinLinesTextGenerator : ITextGenerator
	{
		...
		private void GenerateLines( Bitmap textDestination,ArrayList arrHor,ArrayList arrVert)
		{
			...
			//you can define the range the colors of the lines can be between
			...
			int whichColors=rand.BetweenTwo(1,4);
			switch (whichColors)
			{
				case 1: 
						gMin=100;	//PARAM ,the range the colors can be between  
						gMax=255;	//PARAM ,the higher the number, the colors are lighter 
 						break;
				case 2:
						bMin=100;	//PARAM ,the range the colors can be between  
						bMax=255;	//PARAM ,the higher the number, the colors are lighter 
						break;
				case 3:
						rMin=100;	//PARAM ,the range the colors can be between  
						rMax=255;	//PARAM ,the higher the number, the colors are lighter 	
						break;
			}
			//vertical lines
