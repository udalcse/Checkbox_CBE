...
namespace Checkbox.Common.Captcha.Image.TextGenerators
{
	...
	/// </summary>
	internal class CaughtInTheNet2TextGenerator : ITextGenerator
	{
	    public void DrawText(string text, Bitmap textDestination)
		{
			...
			Color letterColor=rand.GetColorBetween(rMin, rMax, gMin,gMax,bMin, bMax); //the color of the text
			Color backColor=Color.FromArgb(255-letterColor.R,255-letterColor.G,255-letterColor.B); //the color of the background and of the lines 
