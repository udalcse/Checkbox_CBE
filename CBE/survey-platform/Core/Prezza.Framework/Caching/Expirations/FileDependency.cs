...
namespace Prezza.Framework.Caching.Expirations
{
	...
	public class FileDependency : ICacheItemExpiration, ISerializable
	{
		...
		public FileDependency(string fullFileName)
		{
			...
			{
				throw new ArgumentNullException("fullFileName", "File name was null.");
			}
			if (fullFileName.Length == 0)
			{
				throw new ArgumentOutOfRangeException("fullFileName", "File name was empty.");
			}
			...
			{
				throw new ArgumentException("Invalid file name.", "fullFileName");
			}
