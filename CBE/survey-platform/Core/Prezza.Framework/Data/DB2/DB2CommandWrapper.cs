...
namespace Prezza.Framework.Data.DB2
{
    ...
    public class DB2CommandWrapper : DBCommandWrapper
    {
        ...
        internal DB2CommandWrapper(string commandText, CommandType commandType, char parameterToken, object[] parameterValues)
        ...
        {
            DB2Parameter param = CreateParameter(name, DbType.String, size, direction, nullable, precision, scale, sourceColumn, sourceVersion, value);
        ...
        {
            DB2Parameter param = CreateParameter(name, dbType, 0, direction, false, 0, 0, sourceColumn, sourceVersion, value);
            this.command.Parameters.Add(param);
        }
        ...
        {
            DB2Parameter param = CreateParameter(name, dbType, 0, direction, false, 0, 0, string.Empty, DataRowVersion.Default, value);
            this.command.Parameters.Add(param);
        }
        ...
        {
            this.parameterToken = parameterToken;
            using (DB2Command newCommand = CreateNewCommandAndConnectionForDiscovery())
            {
        ...
        /// Create a parameter.
        /// </devdoc>        
        private DB2Parameter CreateParameter(string name, DbType type, int size, ParameterDirection direction, bool nullable, byte precision, byte scale, string sourceColumn, DataRowVersion sourceVersion, object value)
        {
