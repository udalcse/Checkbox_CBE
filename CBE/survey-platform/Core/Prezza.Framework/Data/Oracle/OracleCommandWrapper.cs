...
namespace Prezza.Framework.Data.Oracle
{
    /// <summary>
    ...
    public class OracleCommandWrapper : DBCommandWrapper
    {
        ...
        /// <param name="sourceVersion"><para>One of the <see cref="DataRowVersion"/> values.</para></param>
        /// <param name="value"><para>The value of the parameter.</para></param>      
        public void AddParameter(string name, OracleDbType oracleType, int size, ParameterDirection direction, bool nullable, byte precision, byte scale, string sourceColumn, DataRowVersion sourceVersion, object value)
        {
        ...
        /// <summary>
        /// Adds a new instance of an <see cref="OracleParameter"/> object to the command set as <see cref="ParameterDirection" /> value of Output.
        /// </summary>
        ...
        {
            this.command.Parameters.Add(CreateParameter(name, dbType, size, direction, false, 0, 0, String.Empty, DataRowVersion.Default, value));
        }
        ...
        protected override void DoAssignParameterValues()
        {
            ...
            {
                throw new InvalidOperationException(string.Empty); //SR.ExceptionMessageParameterMatchFailure);
            }
