...
{
	/// <summary>
	/// Implements a TypeConverter to for IPAddress objects.
	/// </summary>
	public class IPTypeConverter : TypeConverter
	{
		...
		{
			if( type.IsSubclassOf( typeof( IPAddress ) ) )
				return true;
