...
namespace Xheo.Licensing
{
	...
	internal
#endif
		class NonCommercialLimit : Limit
	{
		////////////////////////////////////////////////////////////////////////////////
		#region Fields
		...
		public override string Description
		{
			get
			{
				return Internal.StaticResourceProvider.CurrentProvider.GetString( "MNCL_Description" );
			}
		}
		...
		{
			if( String.Compare( node.Attributes[ "type" ].Value, "NonCommercial", false, System.Globalization.CultureInfo.InvariantCulture ) != 0 )
				return false;
