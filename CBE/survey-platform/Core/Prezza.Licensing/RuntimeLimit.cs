...
namespace Xheo.Licensing
{
		...
		class RuntimeLimit : Limit
	{
		...
		public override string Description
		{
			get
			{
				return Internal.StaticResourceProvider.CurrentProvider.GetString( "MRTL_Description" );
			}
		}
		...
		public override bool Validate( LicenseContext context, Type type, object instance )
		{
			...
			License.InvalidReason = Internal.StaticResourceProvider.CurrentProvider.GetString( "E_RuntimeOnly" );
			return false;
		}
		...
		{
			if( String.Compare( node.Attributes[ "type" ].Value, "Runtime", false, System.Globalization.CultureInfo.InvariantCulture ) != 0 )
				return false;
