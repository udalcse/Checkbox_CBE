...
namespace Xheo.Licensing
{
		...
		class DesigntimeLimit : Limit
	{
		...
		public override string Description
		{
			get
			{
				return Internal.StaticResourceProvider.CurrentProvider.GetString( "MDTL_Description" );
			}
		}
		...
		public override bool Validate( LicenseContext context, Type type, object instance )
		{
			...
			License.InvalidReason = Internal.StaticResourceProvider.CurrentProvider.GetString( "E_DesigntimeOnly" );
			return false;
		}
		...
		{
			if( String.Compare( node.Attributes[ "type" ].Value, "Designtime", false, System.Globalization.CultureInfo.InvariantCulture ) != 0 )
				return false;
