<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="SingleLineText.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Controls.ItemRenderers.SurveyEditor.SingleLineText" %>
...
<script language="C#" runat="server">
    ...
    protected string DateFormat { get; set; }
     protected string YearRange { get; set; }
    /// <summary>
    /// 
    /// </summary>
    ...
    protected override void InlineBindModel()
    {
        ...
        _numericInput.Text = _textInput.Text;
        _dateInput.Text = _textInput.Text;
    ...
    protected void SetDateValues()
    {
         DateTime? minDate = Utilities.GetDate(Model.Metadata["MinDateValue"]);            
            DateTime? maxDate = Utilities.GetDate(Model.Metadata["MaxDataValue"]);
        ...
        if (minDate.HasValue)
            {
                YearRange = Convert.ToString(minDate.Value.Year);
            ...
            if (maxDate.HasValue)
            {
                YearRange = YearRange+":" +Convert.ToInt32(maxDate.Value.Year);
            }else
            {
                YearRange = YearRange+":"+Convert.ToString(DateTime.Now.Year+10);
            }
