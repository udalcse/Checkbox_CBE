...
{
    /// <summary>
    /// Appearance editor for radio buttons items
    /// </summary>
    public partial class Radio_Buttons : UserControlAppearanceEditorBase
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override void UpdateData()
        {
			...
			AppearanceData["Columns"] = int.TryParse(_columnsTxt.Text, out columns) ? columns.ToString() : string.Empty;
