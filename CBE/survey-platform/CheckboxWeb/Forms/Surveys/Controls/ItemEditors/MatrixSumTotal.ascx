<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="MatrixSumTotal.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Controls.ItemEditors.MatrixSumTotal" %>
<%@ Import Namespace="Checkbox.Web" %>
<%@ Register Src="~/Forms/Surveys/Controls/ItemEditors/QuestionTextEditor.ascx" TagPrefix="qte" TagName="QuestionTextEditor" %>
<%@ Register Src="~/Forms/Surveys/Controls/ItemEditors/MatrixSumTotalBehavior.ascx" TagPrefix="be" TagName="Behavior" %>
    ...
    <div class="clear"></div>
     ...
     <div class="tabContentContainer">
        ...
        <div id="itemEditorTabs-1-tabContent" class="padding10">
            <be:Behavior ID="_behaviorEditor" runat="server" EnableViewState="true" />
        </div>
