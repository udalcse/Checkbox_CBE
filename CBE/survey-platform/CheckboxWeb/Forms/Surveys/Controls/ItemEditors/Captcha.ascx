<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="Captcha.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Controls.ItemEditors.Captcha" %>
<%@ Import Namespace="Checkbox.Web" %>
<%@ Register Src="~/Forms/Surveys/Controls/ItemEditors/QuestionTextEditor.ascx" TagPrefix="qte" TagName="QuestionTextEditor" %>
<%@ Register Src="~/Forms/Surveys/Controls/ItemEditors/CaptchaBehavior.ascx" TagPrefix="be" TagName="Behavior" %>
<%@ Register Src="~/Forms/Surveys/Controls/ItemEditors/CaptchaTextFormatSelector.ascx" TagPrefix="sel" TagName="FormatSelector" %>
...
<%@ Register Src="~/Forms/Surveys/Controls/ItemActiveDisplay.ascx" TagPrefix="ckbx" TagName="ActiveDisplay" %>
 ...
 <script type="text/javascript">
    ...
    <ul id="itemEditorTabs" class="tabContainer">
        ...
        <li><%=WebTextManager.GetText("/controlText/captchaItemEditor/textFormats")%></li>
    ...
    <div class="tabContentContainer">
        ...
        <div id="itemEditorTabs-3-tabContent" class="padding10">
            <sel:FormatSelector ID="_formatSelector" runat="server" />
        </div>
