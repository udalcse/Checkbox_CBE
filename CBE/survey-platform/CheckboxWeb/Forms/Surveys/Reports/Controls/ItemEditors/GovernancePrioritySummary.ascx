<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GovernancePrioritySummary.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Reports.Controls.ItemEditors.GovernancePrioritySummary" %>
...
<%@ Register Src="~/Forms/Surveys/Reports/Controls/ItemEditors/GovernancePrioritySummaryItemOptions.ascx" TagPrefix="ckbx" TagName="GovernancePrioritySummaryItemOptions" %>
 ...
 <script type="text/javascript">
    ...
    <div class="tabContentContainer">
        ...
        <div id="itemEditorTabs-2-tabContent" class="padding10">
            <ckbx:GovernancePrioritySummaryItemOptions ID="_itemBehavior" runat="server" />
        </div>
