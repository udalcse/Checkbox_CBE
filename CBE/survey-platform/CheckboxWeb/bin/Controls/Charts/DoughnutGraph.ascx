...
<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="DoughnutGraph.ascx.cs" Inherits="CheckboxWeb.Controls.Charts.DoughnutGraph" %>
		        ...
		        $(document).ready(function () {
                    ...
                    %>
                        <%if (s > 0) {%>,<%}%>
                        {
                            ...
                            xAxis: <%=s%>,
                            innerSize: '<%=50 * (s + 1) / Series.Length%>%',
                            size: '<%=50 * (s + 2) / Series.Length%>%',
		                    data: [
                            <% 
