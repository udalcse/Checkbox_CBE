    ...
    this.openChildWindow = function (itemId, pageId, baseUrl, additionalParams, windowId, canCloseCallback, closeBtnCallback) {
        ...
        var options = {
            ...
            onShow: function () {
                ...
                //url = "HtmlEditor.aspx?i=15003&p=2&s=1386&l=en-US&onClose=templateEditor.onDialogClosed&html=test dfb&row=1&callback=onHtmlDialogClosed";
                ...
                var div = '<div class="html-wrapper">';
                var dd = url.replace(div, "");
                var d = dd.replace("</div>", "");
                //$('#templateEditorModal').attr("src", url);
                $('#templateEditorModal').attr("src", d);
            }
        };
