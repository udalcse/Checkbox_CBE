<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="RankOrderSummary.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Reports.Controls.ItemRenderers.ReportEditor.RankOrderSummary" %>
...
<div style="margin-top:15px;">
    ...
    <asp:Panel ID="_filterPanel" CssClass="border999 shadow999" runat="server" style="margin-top:15px;"> 
        <div>
