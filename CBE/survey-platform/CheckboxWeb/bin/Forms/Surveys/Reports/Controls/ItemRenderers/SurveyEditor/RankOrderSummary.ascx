<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="RankOrderSummary.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Reports.Controls.ItemRenderers.SurveyEditor.RankOrderSummary" %>
