<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ANALYSIS_RANK_ORDER_SUMMARY_TABLE.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Reports.Controls.AppearanceEditors.ANALYSIS_RANK_ORDER_SUMMARY_TABLE" %>
...
<div class="formInput">
    ...
    <ckbx:MultiLanguageRadioButtonList ID="_optionsOrder" runat="server" Width="100%">
        <asp:ListItem Value="Survey" Text="(Default) Rank" TextId="/pageText/styles/charts/other.ascx/optionsOrder/rank" />
