    ...
    public partial class DoExport : ReportExportPageBase
    {
        ...
        protected override void OnPageLoad()
        {
            ...
            try
            {
                ...
                //Check user rights
                if (!AuthorizationProvider.Authorize(UserManager.GetCurrentPrincipal(), ReportTemplate, "Analysis.Run"))
                {
        ...
        private void ExportWorker(object response)
        {
            try
            {
                ...
                var result = PdfExportManager.ExportReport(ReportTemplateId, ExportSettings);
