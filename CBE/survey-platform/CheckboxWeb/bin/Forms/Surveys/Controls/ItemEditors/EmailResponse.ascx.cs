...
{
    /// <summary>
    /// Editor for email response item
    /// </summary>
    public partial class EmailResponse : UserControlItemEditorBase
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public override void Initialize(int templateId, int pagePosition, ItemData data, string currentLanguage, List<string> surveyLanguages, bool isPagePostBack, EditMode editMode, bool hidePreview)
        {
            ...
            if (TextDecorator != null
                && TextDecorator is EmailResponseItemTextDecorator)
            {
                ...
                _messageTextTxt.Text = ((EmailResponseItemTextDecorator)TextDecorator).Body;
              
                _emailOptions.Initialize((EmailItemTextDecorator)TextDecorator, templateId, pagePosition, currentLanguage);

                _includeResponseDetailsChk.Checked = ((EmailResponseItemTextDecorator)TextDecorator).Data.IncludeResponseDetails;
                _includeMessageItemsChk.Checked = ((EmailResponseItemTextDecorator)TextDecorator).Data.IncludeMessageItems;
                _showPageNumbersChk.Checked = ((EmailResponseItemTextDecorator)TextDecorator).Data.ShowPageNumbers;
                _showQuestionNumbersChk.Checked = ((EmailResponseItemTextDecorator)TextDecorator).Data.ShowQuestionNumbers;
                _showHiddenItemsChk.Checked = ((EmailResponseItemTextDecorator)TextDecorator).Data.ShowHiddenItems;
            }
        }
        ...
        public override void UpdateData()
        {
            ...
            {
                //Get message text
                ((EmailResponseItemTextDecorator)TextDecorator).Body = _textMessageEditor.Visible
                    ? _messageTextTxt.Text.Trim()
                    : _messageEditor.Text;

                //Set other options
                _emailOptions.UpdateData((EmailResponseItemTextDecorator)TextDecorator);

                ((EmailResponseItemTextDecorator)TextDecorator).Data.IncludeResponseDetails = _includeResponseDetailsChk.Checked;
                ((EmailResponseItemTextDecorator)TextDecorator).Data.IncludeMessageItems = _includeMessageItemsChk.Checked;
                ((EmailResponseItemTextDecorator)TextDecorator).Data.ShowPageNumbers = _showPageNumbersChk.Checked;
                ((EmailResponseItemTextDecorator)TextDecorator).Data.ShowQuestionNumbers = _showQuestionNumbersChk.Checked;
                ((EmailResponseItemTextDecorator)TextDecorator).Data.ShowHiddenItems = _showHiddenItemsChk.Checked;
                ((EmailResponseItemTextDecorator)TextDecorator).Data.Alias = _aliasText.Text;
            }
        }
