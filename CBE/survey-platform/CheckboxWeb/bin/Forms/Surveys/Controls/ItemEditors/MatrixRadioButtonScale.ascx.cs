...
{
    public partial class MatrixRadioButtonScale : UserControlItemEditorBase
    {
        ...
        public override void Initialize(int templateId, int pagePosition, ItemData data, string currentLanguage, List<string> surveyLanguages, bool isPagePostBack, EditMode editMode, bool hidePreview)
        {
            ...
            if (TextDecorator != null
                && TextDecorator is RatingScaleItemTextDecorator)
            {
                ...
                _behaviorEditor.Initialize(((RatingScaleItemTextDecorator)TextDecorator), templateId, pagePosition, editMode, currentLanguage);
        ...
        public override bool DoesItemContainEnoughInformation(out string message)
        {
            ...
            //if (_columnOptionsEditor.OptionsCount == 0)//(SelectItemData.Options.Count == 0)

            if (((RatingScaleItemData) ItemData).Options.Count == 0)
            {
