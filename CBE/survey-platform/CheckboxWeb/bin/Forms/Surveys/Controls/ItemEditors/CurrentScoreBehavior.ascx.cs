...
{
    /// <summary>
    /// Behavior editor for current score item
    /// </summary>
    public partial class CurrentScoreBehavior : Checkbox.Web.Common.UserControlBase
    {
        /// <summary>
        /// Initialize editor
        /// </summary>
        ...
        public void Initialize(CurrentScoreItemData itemData, int surveyId, int pagePosition)
        {
            //fill page list
        ...
        /// </summary>
        /// <param name="itemData"></param>
        public void UpdateData(CurrentScoreItemData itemData)
        {
