<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="Email.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Controls.ItemRenderers.SurveyEditor.Email" %>
...
<div class="padding10">
    ...
    <div class="formInput">
        ...
        <div style="margin-left:15px;"><asp:Label ID="_format" runat="server" Text='<%# Model.Metadata["MessageFormat"] %>' /></div>
    </div>

    <div class="formInput">
        <p><label><ckbx:MultiLanguageLiteral ID="_fromLbl" runat="server" TextId="/controlText/emailItemEditor/emailFrom" /></label></p>
        <div style="margin-left:15px;"><asp:Label ID="_from" runat="server" Text='<%# Model.InstanceData["From"] %>' /></div>
    </div>

    <div class="formInput">
        <p><label><ckbx:MultiLanguageLiteral ID="_toLbl" runat="server" TextId="/controlText/emailItemEditor/emailTo" /></label></p>
        <div style="margin-left:15px;"><asp:Label ID="_to" runat="server" Text='<%# Model.InstanceData["To"] %>' /></div>
    </div>
    
    <div class="formInput">
        <p><label><ckbx:MultiLanguageLiteral ID="_bccLbl" runat="server" TextId="/controlText/emailItemEditor/emailBcc" /></label></p>
        <div style="margin-left:15px;"><asp:Label ID="_bcc" runat="server"  Text='<%# Model.InstanceData["Bcc"] %>' /></div>
    </div>

    <div class="formInput">
        <p><label><ckbx:MultiLanguageLiteral ID="_subjectLbl" runat="server" TextId="/controlText/emailItemEditor/emailSubject" /></label></p>
        <div style="margin-left:15px;"><asp:Label ID="_subject" runat="server" Text='<%# Model.InstanceData["Subject"] %>' /></div>
    </div>
    ...
    <div class="formInput">
        ...
        <div class="border999 shadow999 padding10" style="margin-left:15px;margin-top:10px;"><asp:Label ID="_body" runat="server" Text='<%# GetBody() %>' /></div>
    </div>
