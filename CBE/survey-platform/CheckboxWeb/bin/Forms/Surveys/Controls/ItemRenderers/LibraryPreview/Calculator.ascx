<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="Calculator.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Controls.ItemRenderers.LibraryPreview.Calculator" %>
