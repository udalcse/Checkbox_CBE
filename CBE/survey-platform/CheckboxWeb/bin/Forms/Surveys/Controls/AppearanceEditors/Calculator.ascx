<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="Calculator.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Controls.AppearanceEditors.Calculator" %>

<div class="itemEditorLabel_100">
    <ckbx:MultiLanguageLabel ID="_widthLbl" runat="server" TextId="/controlText/singleLineTextAppearanceEditor/width" />
</div>
...
<div class="itemEditorLabel_100">
    <ckbx:MultiLanguageLabel ID="_labelPositionLbl" runat="server" TextId="/controlText/singleLineTextAppearanceEditor/labelPosition" />
</div>
