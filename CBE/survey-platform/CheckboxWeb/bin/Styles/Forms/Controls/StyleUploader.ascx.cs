...
{
    /// <summary>
    /// Control to handle uploading styles to Checkbox. Copied from survey uploader
    /// </summary>
    public partial class StyleUploader : Checkbox.Web.Common.UserControlBase
    {
        /// <summary>
        /// 
        /// </summary>
        ...
        public string StyleName
        {
            get 
            {
                ...
                {
                    _parsedNameTxt.Value = LoadStyleNameFromXml();
                }
        ...
        /// </summary>
        private string LoadStyleNameFromXml()
        {
