...
namespace CheckboxWeb.Services
{
    ...
    public class SurveyResponseService : ISurveyResponseService
    {
        ...
        /// <param name="sessionKey"></param>
        /// <returns></returns>
        public ServiceOperationResult<SurveyResponsePage[]> GetAllResponsePages(Guid sessionKey, object cacheObject, Guid? rGuid = null)
        {
            try
            {
                return new ServiceOperationResult<SurveyResponsePage[]>
                {
                    CallSuccess = true,
                    ResultData = SurveyResponseServiceImplementation.GetAllSurveyResponsePages(sessionKey, cacheObject, rGuid)
                };
            }
            catch (Exception ex)
            {
        ...
        /// <param name="sessionKey"></param>
        /// <returns></returns>
        public ServiceOperationResult<ResponseSessionState> CreateResponse(Guid sessionKey, object cacheContext)
        {
            try
            {
                 return new ServiceOperationResult<ResponseSessionState>
                {
                    CallSuccess = true,
                    ResultData = SurveyResponseServiceImplementation.CreateNewResponse(sessionKey, cacheContext)
                };
            }
            catch (Exception ex)
            {
