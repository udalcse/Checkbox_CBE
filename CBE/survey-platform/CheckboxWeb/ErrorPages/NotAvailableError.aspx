<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NotAvailableError.aspx.cs" Inherits="CheckboxWeb.ErrorPages.NotAvailableError" %>
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head id="Head1" runat="server">
        ...
        <ckbx:ResolvingCssElement ID="ResolvingCssElement1" runat="server" Source="../App_Themes/CheckboxTheme/Checkbox.css" />
    </head>
    <body>
                ...
                <div class="fixed_1400 centerContent">
                    <div class="headerWrapper">
                        <ul class="pageHeader allMenu">
                            <li><h3>The page is not available</h3></li>
                    ...
                    <div class="url-default">
                        <a href="<%= ResolveUrl("~/") %>" >Return to default page</a>
                        <br class="clear" />
                       <div class="spacing">&nbsp;</div>
                   </div>
                </div>
