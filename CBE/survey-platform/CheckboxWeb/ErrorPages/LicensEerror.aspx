        ...
        <div class="formContainer">
            ...
            <div class="contentWrapper padding10">
                <div class="fixed_1400 centerContent">
                    ...
                    <div class="introPage">
                        <p>
                            <span class="left fixed_150 label">Error Message:</span>
                            <span class="left" style="font-family:Courier New"><%= Server.HtmlEncode(HttpContext.Current.Items["LicenseErrorMessage"] != null ? HttpContext.Current.Items["LicenseErrorMessage"].ToString() : string.Empty)%></span>
                            <br class="clear" />
                        </p>
                   </div>
                </div>
