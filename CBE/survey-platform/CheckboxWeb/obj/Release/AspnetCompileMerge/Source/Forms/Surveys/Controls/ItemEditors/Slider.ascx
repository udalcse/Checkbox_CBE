<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="Slider.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Controls.ItemEditors.Slider" %>
<%@ Import Namespace="Checkbox.Web" %>
<%@ Register Src="~/Forms/Surveys/Controls/ItemEditors/QuestionTextEditor.ascx" TagPrefix="qte"
    TagName="QuestionTextEditor" %>
<%@ Register Src="~/Forms/Surveys/Controls/ItemEditors/SliderBehavior.ascx" TagPrefix="be"
    TagName="Behavior" %>
