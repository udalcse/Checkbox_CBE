<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="NetPromoterScoreStatisticsTable.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Reports.Controls.ItemEditors.NetPromoterScoreStatisticsTable" %>
...
<%@ Register Src="~/Forms/Surveys/Reports/Controls/ItemEditors/NetPromoterScoreStatisticsTableOptions.ascx" TagPrefix="ckbx" TagName="Options" %>
