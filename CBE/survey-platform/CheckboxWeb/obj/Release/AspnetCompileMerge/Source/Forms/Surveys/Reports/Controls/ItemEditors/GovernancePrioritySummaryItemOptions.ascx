<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GovernancePrioritySummaryItemOptions.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Reports.Controls.ItemEditors.GovernancePrioritySummaryItemOptions" %>
