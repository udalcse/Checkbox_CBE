<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="ExportProgress.aspx.cs" MasterPageFile="~/Dialog.Master" Inherits="CheckboxWeb.Forms.Surveys.ExportProgress" %>
...
<asp:Content ID="script" ContentPlaceHolderID="_headContent" runat="server">
    <script type="text/javascript">
        ...
        function onProgressComplete(progressData) {
            ...
            //since survey export progress is not real countable, 
            ...
            setTimeout(function () {
                ...
                if (isMobileDevice()) {
                    $("#pdf-download-link").attr("href", progressData.DownloadUrl);
    ...
    <asp:Panel ID="_linkPanel" runat="server" style="margin-top:25px;margin-left:25px;">
        ...
        <asp:Panel id="_directDlDiv" runat="server">
            ...
            <div style="margin-top:15px;">
                ...
                <a href="#" id="pdf-download-link" target="_blank" style="display: none"> Open pdf in new window</a>
            </div>
        </asp:Panel>
