<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="CredentialsEditor.ascx.cs" Inherits="CheckboxWeb.Users.Controls.CredentialsEditor" %>

<%@ Import Namespace="Checkbox.Web" %>

<asp:Panel ID="_loginTypePanel" runat="server" Visible="false" CssClass="leftColumn loginTypeList">
    ...
    <div class="left radioList">
        <ckbx:MultiLanguageRadioButtonList ID="_loginTypeList" runat="server" RepeatDirection="Vertical" AutoPostBack="True">
    ...
    <div class="padding10">
        <div class="formInput">
            <div class="left fixed_150">
                <p>
                    <ckbx:MultiLanguageLabel ID="_usernameLabel" runat="server" AssociatedControlID="_username" TextId="/pageText/users/properties.aspx/username" /></p>
            </div>
            <div class="left">
        ...
        <div class="formInput">
            <div class="left fixed_150">
                <p>
                    <ckbx:MultiLanguageLabel ID="_emailLabel" runat="server" AssociatedControlID="_email" TextId="/pageText/users/properties.aspx/email" /></p>
            </div>
            <div class="left">
        ...
        <asp:PlaceHolder runat="server" ID="_passwordPlace">
            <div class="formInput">
                <div class="left fixed_150">
                    <p>
                        <ckbx:MultiLanguageLabel ID="_passwordLabel" runat="server" AssociatedControlID="_password" TextId="/pageText/users/properties.aspx/password" /></p>
                </div>
                <div class="left">
            ...
            <div class="formInput">
                <div class="left fixed_150">
                    <p>
                        <ckbx:MultiLanguageLabel ID="_passwordConfirmLabel" runat="server" AssociatedControlID="_passwordConfirm" TextId="/pageText/users/properties.aspx/confirmPassword" /></p>
                </div>
                <div class="left">
        ...
        <asp:PlaceHolder runat="server" ID="_domainPlace" Visible="false">
            <div class="formInput">
                <div class="left fixed_150">
                    <p>
                        <ckbx:MultiLanguageLabel ID="_domainLabel" runat="server" AssociatedControlID="_domain" TextId="/pageText/users/properties.aspx/domain" /></p>
                </div>
                <div class="left">
