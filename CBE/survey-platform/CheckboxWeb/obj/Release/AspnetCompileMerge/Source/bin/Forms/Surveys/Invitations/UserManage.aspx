<%@ Page Title="" Language="C#" MasterPageFile="~/DetailList.master" AutoEventWireup="false" CodeBehind="UserManage.aspx.cs" Inherits="CheckboxWeb.Forms.Surveys.Invitations.UserManage" IncludeJsLocalization="true" %>
<%@ Import Namespace="Checkbox.Web" %>
<%@ Register TagPrefix="ckbx" TagName="UserInvitationList" Src="~/Forms/Surveys/Invitations/Controls/UserInvitationList.ascx" %>
...
<asp:Content ID="_left" ContentPlaceHolderID="_leftContent" runat="server">
    <ckbx:UserInvitationList Id="_userInvitationList" runat="server" InvitationSelectedClientCallback="onInvitationSelected"></ckbx:UserInvitationList>
</asp:Content>
