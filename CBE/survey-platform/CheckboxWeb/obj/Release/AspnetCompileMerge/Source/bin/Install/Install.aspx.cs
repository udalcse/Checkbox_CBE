...
namespace CheckboxWeb.Install
{
    ...
    /// </summary>
    public partial class Install : CheckboxServerProtectedPage
    {
        /// <summary>
        /// Progress ke
        /// </summary>
        ...
        protected override void OnInit(EventArgs e)
        {
            ...
            {
                Response.Redirect(ResolveUrl("~/Install/Default.aspx"), false);
                return;
            }
            ...
            //Set continue url
          /*      if (appInstaller.InstallSampleLibraries || appInstaller.InstallSampleStyles || appInstaller.InstallSampleSurveys)
                {
                    String queryString = "?i=";
                    queryString += appInstaller.InstallSampleSurveys ? "v" : String.Empty;
                    queryString += appInstaller.InstallSampleStyles ? "s" : String.Empty;
                    queryString += appInstaller.InstallSampleLibraries ? "l" : String.Empty;
                    redirectUrl = ResolveUrl("~/Install/InstallSamples.aspx") + queryString;
                }
                else
                { */
                    redirectUrl = ResolveUrl("~/Login.aspx");
                //}
