<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="RadioButtonScale.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Controls.ItemRenderers.RadioButtonScale" %>
<%@ Register Src="~/Forms/Surveys/Controls/ItemRenderers/RadioButtonScale_Horizontal.ascx" TagName="RadioButtonsHorizontal" TagPrefix="ckbx" %>
<%@ Register Src="~/Forms/Surveys/Controls/ItemRenderers/RadioButtonScale_Vertical.ascx" TagName="RadioButtonsVertical" TagPrefix="ckbx" %>
