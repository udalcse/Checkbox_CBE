...
(function($) {
    ...
    * @option {array} onlyCols  An array of numbers. Only column with the matching column index will be included in the highlighting process.
    *							Index starting at 1!
    *							Default value: [] (empty array)
    * @option {array} ignoreRows  An array of numbers. Only rows with the matching row index will be included in the highlighting process.
    *							Index starting at 1!
    *							Default value: [] (empty array)
    *
                    ...
                    for (cI = 0; cI < row.cells.length; cI++) {
                        ...
                        if ((nodeName == 'TBODY' && settings.bodyCols)
                            ...
                            while (--s >= 0) {
                                ...
                                //Don't include row if "IgnoreRows" is specified
                                // and column is not in list
                                if ($.inArray(rowI + 1, settings.ignoreRows) > -1) {
                                    break;
                                }
    
                                //Don't include col if "Only Cols" is specified
                                // and column is not in list
                                if (settings.onlyCols.length > 0
                                    && !($.inArray(rI + 1, settings.onlyCols) > -1)) {
                                    break;
                                }
