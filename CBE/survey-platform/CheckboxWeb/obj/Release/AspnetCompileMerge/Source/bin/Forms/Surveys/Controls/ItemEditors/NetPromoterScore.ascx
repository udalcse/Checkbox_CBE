<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="NetPromoterScore.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Controls.ItemEditors.NetPromoterScore" %>
<%@ Import Namespace="Checkbox.Web" %>
<%@ Register Src="~/Forms/Surveys/Controls/ItemEditors/QuestionTextEditor.ascx" TagPrefix="qte" TagName="QuestionTextEditor" %>
<%@ Register Src="~/Forms/Surveys/Controls/ItemEditors/NetPromoterScoreBehavior.ascx" TagPrefix="be" TagName="Behavior" %>
