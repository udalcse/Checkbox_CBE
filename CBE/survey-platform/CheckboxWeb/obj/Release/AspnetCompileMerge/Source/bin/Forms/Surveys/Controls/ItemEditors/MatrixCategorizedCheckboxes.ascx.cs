...
{
    public partial class MatrixCategorizedCheckboxes : UserControlItemEditorBase
    {
        private ResponseTemplate _responseTemplate;
        private EditMode _editMode;
        private CategorizedMatrixItemTextDecorator _textDecorator;
        private CategorizedMatrixItemData _matrixItemData;
        ...
        /// 
        /// </summary>
        private CategorizedMatrixItemTextDecorator MatrixTextDecorator
        {
            get
            {
                ...
                {
                    _textDecorator =
                        HttpContext.Current.Session[Surveys.Controls.ItemEditors.CategorizedMatrix.InMemoryMatrixItemEditorSessionKey] as CategorizedMatrixItemTextDecorator;
                }
        ...
        /// </summary>
        private CategorizedMatrixItemData MatrixItemData
        {
            get
            {
        ...
        public override void Initialize(int templateId, int pagePosition, ItemData data, string currentLanguage, List<string> surveyLanguages, bool isPagePostBack, EditMode editMode, bool hidePreview)
        {
                ...
                && TextDecorator is SelectItemTextDecorator)
            {
                ...
                _selectOptionsEditor.Initialize((SelectItemTextDecorator)TextDecorator, isPagePostBack, ResponseTemplate, PagePosition, true, editMode);
                _behaviorEditor.Initialize(((SelectItemTextDecorator)TextDecorator), false, false, templateId, pagePosition, editMode, currentLanguage, true, true);
