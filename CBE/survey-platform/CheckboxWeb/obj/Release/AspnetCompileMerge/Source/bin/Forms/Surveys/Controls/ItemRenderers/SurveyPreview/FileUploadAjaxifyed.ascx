<%@ Control Language="C#" AutoEventWireup="false"  CodeBehind="FileUploadAjaxifyed.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Controls.ItemRenderers.SurveyPreview.FileUploadAjaxifyed" %>
        ...
        <asp:Panel ID="_contentPanel" runat="server" CssClass="itemContent">
            ...
            <asp:Panel ID="_bottomAndOrRightPanel" runat="server" CssClass="bottomAndOrRightContainer">
                ...
                <asp:Panel ID="_uploadedFilePanel" runat="server" style="display: none;">
                    ...
                    <a id="clearButton_<%=Model.ItemId %>" data-role="button" href="#" class="ckbxButton roundedCorners border999 shadow999 orangeButton" ><%= TextManager.GetText("/controlText/UploadItemRenderer/clear") %></a>
                </asp:Panel>
