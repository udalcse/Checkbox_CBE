<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RankOrderSummaryTable.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Reports.Controls.ItemEditors.RankOrderSummaryTable" %>
...
<%@ Register Src="~/Forms/Surveys/Reports/Controls/ItemEditors/RankOrderSummaryBehavior.ascx" TagPrefix="ckbx" TagName="RankOrderBehavior" %>
...
<script type="text/javascript">
    ...
    <div class="tabContentContainer">
        ...
        <div id="itemEditorTabs-2-tabContent" class="padding10">
            <ckbx:RankOrderBehavior ID="_behavior" runat="server" />
        </div>
