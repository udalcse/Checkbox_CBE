...
{
    public partial class RankOrder : UserControlItemEditorBase
    {
        ...
        /// 
        /// </summary>
        public override bool SupportsEmbeddedAppearanceEditor
        {
            get { return true; }
        }
        ...
        public override void Initialize(int templateId, int pagePosition, ItemData data, string currentLanguage, List<string> surveyLanguages, bool isPagePostBack, EditMode editMode, bool hidePreview)
        {
            ...
            if (!isPagePostBack)
            {
                SelectItemData = ((RankOrderItemData)data).Clone() as RankOrderItemData;
            }
            ...
            if (TextDecorator is SelectItemTextDecorator)
            {
                ...
                _behaviorEditor.Initialize(((SelectItemTextDecorator)TextDecorator));
            }
        }
        ...
        private void Update(bool updateTextDecoratorOptions)
        {
            if (TextDecorator is SelectItemTextDecorator)
            {
                ...
                _selectOptionsEditor.SetRankOrderOptionType(itemData.RankOrderOptionType);
