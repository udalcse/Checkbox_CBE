...
<asp:Content ID="_head" runat="server" ContentPlaceHolderID="_head">
    ...
    <script type="text/javascript">
       ...
       function OpenMatrixEdit(btnEdit)
       {

           debugger;
           var strValue = btnEdit.id;
           var n = strValue.lastIndexOf("_");
           var fieldName = strValue.substring(n + 1, strValue.length);
          // var fieldType = $("#ctl00__pageContent__properties_ctl100_dd_" + fieldName).val();
           var dropDownId = "dd_" + fieldName;
           var fieldType = $("select[id*='" + dropDownId + "']").val();
