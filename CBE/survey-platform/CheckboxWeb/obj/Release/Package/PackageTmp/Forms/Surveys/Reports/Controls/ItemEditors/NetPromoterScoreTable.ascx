<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="NetPromoterScoreTable.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Reports.Controls.ItemEditors.NetPromoterScoreTable" %>
...
<%@ Register Src="~/Forms/Surveys/Reports/Controls/ItemEditors/NetPromoterScoreTableOptions.ascx" TagPrefix="ckbx" TagName="Options" %>
