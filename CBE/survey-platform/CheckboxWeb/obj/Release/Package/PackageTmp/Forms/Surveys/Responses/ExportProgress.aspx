<%@ Page language="c#" Inherits="CheckboxWeb.Forms.Surveys.Responses.ExportProgress" MasterPageFile="~/Dialog.Master" Codebehind="ExportProgress.aspx.cs" %>
    ...
    <div class="dialogSubContainer">
        <div class="dashStatsWrapper border999 shadow999">
            <div class="dashStatsHeader" style="padding:5px;">
                <span class="mainStats left"><%=WebTextManager.GetText("/pageText/analytics/data/doexport.aspx/title")%></span>
            </div>
            <div class="padding10">
