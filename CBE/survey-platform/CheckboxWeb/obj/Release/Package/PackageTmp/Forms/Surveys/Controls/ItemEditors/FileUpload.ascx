<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="FileUpload.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Controls.ItemEditors.FileUpload" %>
<%@ Import Namespace="Checkbox.Web" %>
<%@ Register Src="~/Forms/Surveys/Controls/ItemEditors/QuestionTextEditor.ascx" TagPrefix="qte" TagName="QuestionTextEditor" %>
<%@ Register Src="~/Forms/Surveys/Controls/ItemEditors/FileUploadBehavior.ascx" TagPrefix="be" TagName="Behavior" %>
