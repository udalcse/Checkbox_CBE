<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="MatrixRadioButtons.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Controls.ItemEditors.MatrixRadioButtons" %>
...
<%@ Register Src="~/Forms/Surveys/Controls/ItemEditors/ColumnOptionsEditor.ascx"TagPrefix="cle" TagName="ColumnOptionsEditor" %>
    ...
    <div class="tabContentContainer">
        ...
        <div id="itemEditorTabs-1-tabContent">
            <sle:SelectOptionsEditor ID="_selectOptionsEditor" runat="server" MatrixColumnItem="True" />
        </div>
