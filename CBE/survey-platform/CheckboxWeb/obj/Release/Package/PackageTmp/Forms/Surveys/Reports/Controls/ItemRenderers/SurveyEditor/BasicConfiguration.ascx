<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="BasicConfiguration.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Reports.Controls.ItemRenderers.SurveyEditor.BasicConfiguration" %>
...
<ul class="dashStatsContent allMenu">
    ...
    <li><%= WebTextManager.GetText(AnalysisItem.UseAliases ? "/common/yes" : "/common/no") %></li>
    <div class="clear"></div>
</ul>
<div class="clear"></div>
    ...
    <li>
        <ol style="list-style-type:square;">
            <asp:Repeater ID="_sourceItemRepeater" runat="server">
                <ItemTemplate>
                    <li><asp:Label ID="_itemTxtLbl" runat="server" Text='<%# DataBinder.Eval(Container.DataItem, "ReportingText")  %>' /></li>
                    <div class="clear"></div>
                </ItemTemplate>
                </asp:Repeater>
        </ol>
