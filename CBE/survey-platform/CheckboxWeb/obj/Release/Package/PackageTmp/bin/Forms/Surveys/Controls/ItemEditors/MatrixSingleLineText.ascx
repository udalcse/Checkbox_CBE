<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="MatrixSingleLineText.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Controls.ItemEditors.MatrixSingleLineText" %>
...
<%@ Register Src="~/Forms/Surveys/Controls/ItemEditors/ColumnOptionsEditor.ascx" TagPrefix="cle" TagName="ColumnOptionsEditor" %>
    ...
    <div class="tabContentContainer">
        ...
        <div id="itemEditorTabs-2-tabContent" class="padding10">
            <asp:PlaceHolder ID="_appearancePlace" runat="server"></asp:PlaceHolder>
        </div>
