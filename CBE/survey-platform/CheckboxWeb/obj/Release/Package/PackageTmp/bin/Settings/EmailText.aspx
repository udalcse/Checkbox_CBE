<%@ Page Title="" Language="C#" MasterPageFile="~/Dialog.Master" CodeBehind="EmailText.aspx.cs" Inherits="CheckboxWeb.Settings.EmailText" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="_pageContent" runat="server">
    ...
    <div class="dashStatsWrapper border999 shadow999">
        <div class="dashStatsHeader">
            <span class="mainStats fixed_125 left">Email text</span>
