<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="NetPromoterScore_Vertical.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Controls.ItemRenderers.SurveyMobile.NetPromoterScore_Vertical" %>
