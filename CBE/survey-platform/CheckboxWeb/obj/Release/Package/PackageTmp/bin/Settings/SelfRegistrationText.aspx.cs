...
{
    public partial class SelfRegistrationText : TextSettings
    {
        protected override string PageTitleTextId { get { return "/pageText/settings/selfRegistrationText.aspx/title"; } }
        ...
        {
            return GetTextTable(_validationPageLanguageList.SelectedValue ?? DefaultLanguage, "/selfRegistrationScreen/");
        }
    }
}