...
{
    public partial class PageConditions : SecuredPage
    {
        /// <summary>
        /// ID of page
        /// </summary>
        ...
        protected override void  OnPageInit()
        {
            ...
            if (!Page.IsPostBack)
            {
                ...
                _ruleEditor.Initialize(rds, RuleType.PageCondition, ResponseTemplateId, tp.Position-1, PageId, null, EditLanguage);
            }
