<%@ Page Language="C#" AutoEventWireup="false" CodeBehind="ExportProgress.aspx.cs" MasterPageFile="~/Dialog.Master" Inherits="CheckboxWeb.Users.CsvExport.ExportProgress" %>
    ...
    <div class="dialogSubContainer">
        <div class="dashStatsWrapper border999 shadow999">
            <div class="dashStatsHeader" style="padding:5px;">
                <span class="mainStats left">Creating CSV</span>
            </div>
            <div class="padding10">
