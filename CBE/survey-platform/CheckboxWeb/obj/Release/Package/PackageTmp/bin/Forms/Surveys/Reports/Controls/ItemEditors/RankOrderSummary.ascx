<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="RankOrderSummary.ascx.cs" Inherits="CheckboxWeb.Forms.Surveys.Reports.Controls.ItemEditors.RankOrderSummary" %>
