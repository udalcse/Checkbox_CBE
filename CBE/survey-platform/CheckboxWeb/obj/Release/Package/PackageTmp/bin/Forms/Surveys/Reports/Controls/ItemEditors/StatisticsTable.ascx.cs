...
{
    public partial class StatisticsTable : UserControlAnalysisItemEditorBase
    {
        /// <summary>
        ...
        public override void Initialize(int templateId, int pagePosition, Checkbox.Forms.Items.Configuration.ItemData data, string currentLanguage, List<string> surveyLanguages, bool isPagePostBack, Checkbox.Forms.EditMode editMode, bool hidePreview)
        {
            ...
            if (ItemData is StatisticsItemData)
            {
                ...
                if (sourceResponseTemplateId.HasValue)
                {
                    ...
                    allowedItemTypes.Add("RadioButtonScale");
                    ...
                    _sourceItemSelector.Initialize(
                        ...
                        null,
                        ((StatisticsItemData)ItemData).SourceItemIds,
                        IsPagePostBack);

                    _statisticsOption.Initialize((StatisticsItemData)ItemData);
                }
        ...
        public override void UpdateData()
        {
            ...
            if (ItemData is StatisticsItemData)
            {
                ((StatisticsItemData)ItemData).SourceItemIds.Clear();
                ((StatisticsItemData)ItemData).SourceItemIds.AddRange(_sourceItemSelector.GetSelectedItems());

                _statisticsOption.UpdateData(((StatisticsItemData)ItemData));
