...
namespace CheckboxWeb.Users
{
    ...
    /// 
    /// </summary>
    public partial class Profile : EditUserPage, IStatusPage
    {
        /// <summary>
        /// 
        /// </summary>
        protected override void OnPageInit()
        {
            ...
            //Set the user to edit on the profileEditor
            ...
            string title = IsUserReadOnly || IsExternalUser
                 ...
                 : WebTextManager.GetText("/pageText/users/properties.aspx/profileTab");
            ...
            Master.OkClick += SaveProfileButton_Click;
        ...
        protected void SaveProfileButton_Click(object sender, EventArgs e)
        {
            ...
            try
            {
               _profileEditor.SaveProfileProperties();
                ...
                Master.CloseDialog("{page:'profile'}", true);
            }
            catch (Exception err)
            {
