...
<%@ Control Language="C#" AutoEventWireup="false" CodeBehind="BarGraph.ascx.cs" Inherits="CheckboxWeb.Controls.Charts.BarGraph" %>
		    ...
		    $(function () {
		        ...
		        $(document).ready(function () {
                    ...
                    %>
                        ...
                        {
		                    type: 'bar',
		                    name:  '<b>'+ htmlDecode('<%=EscapeJSStringConst(Series[s].Name)%>') + '</b>',
