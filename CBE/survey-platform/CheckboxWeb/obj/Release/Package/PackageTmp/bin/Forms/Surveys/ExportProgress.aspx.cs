...
{
    public partial class ExportProgress : ResponseTemplateExportPageBase
    {
        /// <summary>
        /// Get worker url
        /// </summary>
        ...
        {
            return ResolveUrl("~/Forms/Surveys/DoExport.aspx?s=" + ResponseTemplateId);
        }
        ...
        protected override void OnPageInit()
        {
            ...
            {
                _backToExportLink.NavigateUrl = "Export.aspx" + Request.UrlReferrer.Query;
            }
            _backToExportLink.NavigateUrl = "Export.aspx?s=" + ResponseTemplateId + "&loc=" + ExportSettings.Language + "&mode=" + PreviewMode;
        }
        ...
        protected override void OnPageLoad()
        {
            ...
            ProgressProvider.SetProgress(ProgressKey, new ProgressData
            {
                ...
                CurrentItem = 0,
                TotalItemCount = 100,
                Message = WebTextManager.GetText("/pageText/forms/surveys/exportProgress.aspx/pending")
            }, null);
        ...
        private void DownloadFile(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                HttpContext.Current.Response.AddHeader("Content-Disposition", string.Format(
                                                        ...
                                                        FileUtilities.FixFileName(ResponseTemplate.Name, string.Empty)));
