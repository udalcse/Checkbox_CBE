...
namespace Checkbox.Wcf.Services.Proxies
{
    ...
    public interface IUserManagementService
    {
        ...
        [WebGet]
        [OperationContract]
        ServiceOperationResult<PagedListResult<PageItemUserData[]>> GetPageItemUsersData(string authToken, string provider, int pageNumber, int pageSize, string sortField, bool sortAscending, string filterField, string filterValue);
        ...
        [WebGet]
        [OperationContract]
        ServiceOperationResult<PagedListResult<string[]>> ListUserIdentities(string authToken, int pageNumber, int pageSize, string sortField, bool sortAscending, string filterField, string filterValue);
        ...
        [OperationContract]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest)]
        ServiceOperationResult<bool> UnlockUser(string authToken, string uniqueIdentifier);
        ...
        [OperationContract]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest)]
        ServiceOperationResult<bool> LockUser(string authToken, string uniqueIdentifier);
        ...
        /// </summary>
        /// <param name="authToken">An encrypted forms auth token identifying the requesting user.</param>
        /// <param name="databaseIdList">The list the user group IDs to delete.</param>
        /// <returns>
        /// <para>A <see cref="ServiceOperationResult{T}"/> object where T is of type <see cref="int"/>.</para>
        ...
        [OperationContract]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest)]
        ServiceOperationResult<string[]> DeleteUserGroups(string authToken, int[] databaseIdList);
        ...
        /// <param name="groupDatabaseID">The unique identifier of the group.</param>
        /// <returns>
        /// <para>A <see cref="ServiceOperationResult{T}"/> object where T is of type <see cref="object"/>.</para>
        /// <para>The <see cref="ServiceOperationResult{T}.ResultData"/> property contains no data.</para>
        /// All results are wrapped in a ServiceOperationResult object. The <see cref="ServiceOperationResult{T}.CallSuccess"/> property indicates whether or not the action completed successfully.
        ...
        [OperationContract]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest)]
        ServiceOperationResult<object> AddUsersToGroup(string authToken, string[] userUniqueIdentifiers, int groupDatabaseID);

        /// <summary>
        /// Remove a user from a user group.
        /// </summary>
        /// <param name="authToken">An encrypted forms auth token identifying the requesting user.</param>
        /// <param name="groupDatabaseID">The id of the user group.</param>
        ...
        [OperationContract]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest)]
        ServiceOperationResult<object> RemoveUserFromGroup(string authToken, int groupDatabaseID, string userUniqueIdentifier);
        ...
        [OperationContract]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest)]
        ServiceOperationResult<object> RemoveUsersFromGroup(string authToken, int groupDatabaseID, string[] userUniqueIdentifiers);
        ...
        [OperationContract]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest)]
        ServiceOperationResult<object> RemoveAllUsersFromGroup(string authToken, int groupDatabaseID);
        ...
        [OperationContract]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest)]
        ServiceOperationResult<object> DeleteAllGroupMembersFromCheckBox(string authToken, int groupDatabaseID);
                                       
        /// <summary>
        /// Set the default policy permissions for a user group.
        /// </summary>
        /// <param name="authToken">An encrypted forms auth token identifying the requesting user.</param>
        /// <param name="databaseID">The id of the user group.</param>
        ...
        [OperationContract]
        [WebInvoke(BodyStyle = WebMessageBodyStyle.WrappedRequest)]
        ServiceOperationResult<object> SetGroupDefaultPolicyPermissions(string authToken, int databaseID, string[] permissions);
        ...
        [WebGet]
        [OperationContract]
        ServiceOperationResult<string[]> ListGroupDefaultPolicyPermissions(string authToken, int databaseID);
        ...
        [WebGet]
        [OperationContract]
        ServiceOperationResult<AclEntry[]> ListAllGroupAccessListEntries(string authToken, int databaseID);
        ...
        [WebGet]
        [OperationContract]
        ServiceOperationResult<PagedListResult<PageItemUserData[]>> ListPageItemUserDataForGroup(string authToken, string provider, int groupId, int pageNumber, int pageSize, string sortField, bool sortAscending, string filterField, string filterValue);
        ...
        [WebGet]
        [OperationContract]
        ServiceOperationResult<PagedListResult<PageItemUserData[]>> ListPotentialUsersForNewGroupByProvider(string authToken, string provider, int pageNumber, int pageSize, string sortField, bool sortAscending, string filterField, string filterValue);
